...
printf('<p>We have %d courses currently avaialable.</p>', $result->prodCount);
...
//     // printf('<p>%d rows were updated into the database</p>', $sth->rowCount());
